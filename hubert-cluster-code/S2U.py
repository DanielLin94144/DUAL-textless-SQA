...
output_dir = '/home/daniel094144/data/SQA_code/w2v2_large_100/train_code'
extractor = torch.hub.load('s3prl/s3prl', 'wav2vec2_large_ll60k')    
extractor.eval()
if torch.cuda.is_available():
    extractor = extractor.cuda()
apply_kmeans = ApplyKmeans('/home/daniel094144/discrete_token/w2v2_large_100/km.bin')
...
output_dir = '/home/daniel094144/data/SQA_code/w2v2_large_100/dev_code'
